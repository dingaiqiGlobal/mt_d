...
const routes = [
  ...
  // },
  {
    ...
    component: () => import("../components/spatialAnalysis/spatialAnalysis_inSightAnalysis.vue")
  },
  {
  ...
  },
  {
    ...
    component: () => import("../components/layer/vtLayer/layer_vtLayer_highlight_id.vue")
  },
  {
    path: '/layer_vtLayer_highlight_bytileload',
    name: 'layer_vtLayer_highlight_bytileload',
    component: () => import("../components/layer/vtLayer/layer_vtLayer_highlight_bytileload.vue")
  },
  {
