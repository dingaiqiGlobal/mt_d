                        ...
                        createUiMarker2(flag){
                          ...
                          switch(flag){
                            ...
                            case '3':
                              ...
                              break;
                            case '4':
                              uiMarker2Obj = _this.createUiMarkerWindow('AI模型问询');  
                              break;
                          }
    ...
    bindGltfInfoWindow(){
        ...
        this.viewer.gltfLayer.forEach(function (gltf){
            ...
            if(json.options.properties && json.options.properties.name && json.options.properties.name=="噪音监测屏"){
                let infoWindowObj = SmartStreet.prototype.createInfoWindow('噪音监测屏',"click");
                gltf.setInfoWindow({
                    autoPan:false,
            ...
            if(json.options.properties && json.options.properties.name && json.options.properties.name=="公安井盖"){
                let infoWindowObj = SmartStreet.prototype.createInfoWindow('公安井盖',"click");
                gltf.setInfoWindow({
                    autoPan:false,
                    title: infoWindowObj.title,
                    content: infoWindowObj.content 
            ...
            if(json.options.properties && json.options.properties.name && json.options.properties.name=="交通路灯"){
                let infoWindowObj = SmartStreet.prototype.createInfoWindow('交通路灯',"click");
                gltf.setInfoWindow({
                    autoPan:false,
                    title: infoWindowObj.title,
                    content: infoWindowObj.content 
            ...
            if(json.options.properties && json.options.properties.name && json.options.properties.name=="市政井盖"){
                let infoWindowObj = SmartStreet.prototype.createInfoWindow('市政井盖',"click");
                gltf.setInfoWindow({
                    autoPan:false,
                    title: infoWindowObj.title,
                    content: infoWindowObj.content 
            ...
            if(json.options.properties && json.options.properties.modelName=="中鼎大厦"){
                ...
                let infoWindowObj = SmartStreet.prototype.createBuildingInfoWindow(properties);
                gltf.setInfoWindow({
        ...
        function task(route){
            ...
            _this.carPlayer.on("playing", (param) => {
                ...
                if(param.coordinate[0]==tkStart[0] && param.coordinate[1]==tkStart[1]){
                    ...
                    _this.viewer.gltfLayer.forEach(function (gltf){
                        ...
                        if(json.options.properties && json.options.properties.name && json.options.properties.name=="违规停放货车"){
                            let infoWindowObj = SmartStreet.prototype.createInfoWindow('违规停放');
                            gltf.setInfoWindow({
                                autoPan:false,
                                title: infoWindowObj.title,
                                content: infoWindowObj.content
                ...
                if(param.coordinate[0]==jcpGlbPosition[0] && param.coordinate[1]==jcpGlbPosition[1]){
                    _this.viewer.gltfLayer.forEach(function (gltf){
                        ...
                        if(json.options.properties && json.options.properties.name && json.options.properties.name=="噪音监测屏"){
                            ...
                            let infoWindowObj = SmartStreet.prototype.createInfoWindow('噪音监测屏');
                            gltf.setInfoWindow({
                                autoPan:false,
                                dy:100,
                                title: infoWindowObj.title,
                ...
                if(param.coordinate[0]==gajgGlbPosition[0] && param.coordinate[1]==gajgGlbPosition[1]){
                    _this.viewer.gltfLayer.forEach(function (gltf){
                          ...
                          if(json.options.properties && json.options.properties.name && json.options.properties.name=="公安井盖"){
                            ...
                            let infoWindowObj = SmartStreet.prototype.createInfoWindow('公安井盖');
                            gltf.setInfoWindow({
                                autoPan:false,
                                title: infoWindowObj.title,
                                content: infoWindowObj.content 
                ...
                if(param.coordinate[0]==dgGlbPosition[0] && param.coordinate[1]==dgGlbPosition[1]){
                    _this.viewer.gltfLayer.forEach(function (gltf){
                        ...
                        if(json.options.properties && json.options.properties.name && json.options.properties.name=="交通路灯"){
                            ...
                            let infoWindowObj = SmartStreet.prototype.createInfoWindow('交通路灯');
                            gltf.setInfoWindow({
                                autoPan:false,
                                dy:100,
                                title: infoWindowObj.title,
                ...
                if(param.coordinate[0]==szjgGlbPosition[0] && param.coordinate[1]==szjgGlbPosition[1]){
                    _this.viewer.gltfLayer.forEach(function (gltf){
                        ...
                        if(json.options.properties && json.options.properties.name && json.options.properties.name=="市政井盖"){
                            ...
                            let infoWindowObj = SmartStreet.prototype.createInfoWindow('市政井盖');
                            gltf.setInfoWindow({
                                autoPan:false,
                                title: infoWindowObj.title,
                                content: infoWindowObj.content 
                ...
                if(param.coordinate[0]==parkTip[0] && param.coordinate[1]==parkTip[1]){
                    let infoWindowObj = SmartStreet.prototype.createInfoWindow('实时播报');
                    car.setInfoWindow({
                        autoPan:false,
                        title: infoWindowObj.title,
                        content: infoWindowObj.content
                ...
                if(param.coordinate[0]==parkPlace[0] && param.coordinate[1]==parkPlace[1]){
                    let infoWindowObj = SmartStreet.prototype.createInfoWindow('共享车位');
                    car.setInfoWindow({
                        autoPan:false,
                        title: infoWindowObj.title,
                        content: infoWindowObj.content
                ...
                if(param.coordinate[0]==parkAuto[0] && param.coordinate[1]==parkAuto[1]){
                    let infoWindowObj = SmartStreet.prototype.createInfoWindow('自动泊车');
                    car.setInfoWindow({
                        autoPan:false,
                        title: infoWindowObj.title,
                        content: infoWindowObj.content
                ...
                if(param.coordinate[0]==lpEnd[0] && param.coordinate[1]==lpEnd[1]){
                    let infoWindowObj = SmartStreet.prototype.createInfoWindow('绿波路段');
                    car.setInfoWindow({
                        autoPan:false,
                        title: infoWindowObj.title,
                        content: infoWindowObj.content
                ...
                if(param.coordinate[0]==gjzEnd[0] && param.coordinate[1]==gjzEnd[1]){
                    _this.viewer.gltfLayer.forEach(function (gltf){
                        ...
                        if(json.options.properties && json.options.properties.name && json.options.properties.name=="五道口公交车站"){
                            let infoWindowObj = SmartStreet.prototype.createInfoWindow('五道口公交车站');
                            gltf.setInfoWindow({
                                autoPan:false,
                                title: infoWindowObj.title,
                                content: infoWindowObj.content
...
<!--                <img class="btn-img" :src="playImg"/>-->
    ...
    womenWalk(){
        ...
        function task(route){
            ...
            route[0] = [route[0][0],route[0][1],0];
            route[1] = [route[1][0],route[1][1],2];
            let start = route[0];
            let women = new GLTFMarker(
                [start[0],start[1], 1],
                {
            ...
            let womenPlayer = new RoutePlayer(data, {
                repeat:false,
            });
            womenPlayer.on("playing", (param) => {
                women.setCoordinates(param.coordinate);
                women.updateSymbol({
                    rotationZ: param.rotationZ+180,
                });
            });
            womenPlayer.on('playend', e => {
                _this.viewer.gltfLayer.removeGeometry(women);
            });
            womenPlayer.setUnitTime(1);
            womenPlayer.play();
        }
    }
    ...
    carWrongRoad(){
        ...
        function task(route){
            ...
            _this.wrongRoadPlayer.on("playstart", (param) => {
                let infoWindowObj = SmartStreet.prototype.createInfoWindow('占用公交车道行驶');
    ...
    carRedLight(){
        ...
        function task(route){
            ...
            _this.redLightPlayer.on("playstart", (param) => {
                ...
                let infoWindowObj = SmartStreet.prototype.createInfoWindow('闯红灯');
    ...
    carOverSpeed(){
        ...
        function task(route){
            ...
            _this.overSpeedPlayer.on("playstart", (param) => {
                ...
                let infoWindowObj = SmartStreet.prototype.createInfoWindow('超速');
    ...
    carTurnAround(){
        ...
        function task(route){
            ...
            _this.turnAroundPlayer.on("playstart", (param) => {
                ...
                let infoWindowObj = SmartStreet.prototype.createInfoWindow('违规调头');
